...
public class UserTest {
	...
	void createuser()
	{
		Response CreatRes=UserEndPoints.createUser(userdata);
	...
	void getuser()
	{
		Response ReadRes=UserEndPoints.readUser(userdata.getUsername());
	...
	void updateuser()
	{
		...
		Response UpdateRes=UserEndPoints.updateUser(userdata.getUsername(),userdata);
	...
	void deleteuser()
	{
		Response DeleteRes=UserEndPoints.deleteUser(userdata.getUsername());
